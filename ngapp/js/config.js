...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        ...
                        {
                            files: ['js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js', 'css/plugins/jvectormap/jquery-jvectormap-2.0.2.css']
                        },
                        {
        ...
        .state('struct.department', {
            url: "/department",
            templateUrl: "views/struct/department.html",
            data: {pageTitle: "部门管理"},
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('struct.employee', {
            url: "/employee",
            templateUrl: "views/struct/employee.html"
        })
        .state('struct.employee_detail', {
            url: "/employee_detail",
            templateUrl: "views/struct/employee_detail.html"
        })
        .state('struct.job_title', {
            url: "/job_title",
            templateUrl: "views/struct/job_title.html"
        })
