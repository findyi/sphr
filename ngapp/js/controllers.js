...
function departmentTreeCtrl($scope) {
    $scope.treeConfig = {
        'plugins' : [ 'types', 'dnd' ],
        'types' : {
            'default' : {
    ...
    $scope.employees = [
        {
            "name": "涂飞",
            "job_title": "开发工程师",
            "work_phone": "18611736372",
            "work_email": "tufei@infohold.com"
        },
        {
            "name": "涂飞",
            "job_title": "开发工程师",
...
function modalJobTitleCtrl($scope, $modalInstance, jobTitle) {
    ...
    $scope.getModalTitleText = function() {
    ...
    $scope.getModalSubmitText = function () {
        if ($scope.changeType === 1) {
            return "提 交";
        } else {
            return "修 改";
...
function jobTitleCtrl($scope, $modal) {
    $scope.editJobTitle = function(jobTitle) {
        var modalInstance = $modal.open({
            templateUrl: 'views/struct/modal_job_title.html',
            controller: modalJobTitleCtrl,
            resolve: {
                jobTitle: function() {
                    return jobTitle;
                }
    ...
    $scope.jobTitles = [
        {
            ...
            name: "开发工程师",
            description: "",
            create_time: "2016-01-02 22:09:01"
        },
        {
            id: 1,
            name: "开发工程师",
...
angular
    ...
    .controller('departmentTreeCtrl', departmentTreeCtrl)
    .controller('employeeCtrl', employeeCtrl)
    .controller('jobTitleCtrl', jobTitleCtrl);
